...
export default function Intro() {
  ...
  return (
    ...
    >
      ...
      >
        <span className="font-bold">Hello, I'm Pankaj Jha.</span> I'm a{" "}
      ...
      >
        <Button className="group bg-gray-900 text-white px-7 py-3 rounded-xl outline-none focus:scale-110 hover:scale-110 hover:bg-gray-950 active:scale-105 transition">
          <Link
            href="#contact"
